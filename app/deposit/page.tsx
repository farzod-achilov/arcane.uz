          ...
          <p className="font-body text-[#9CA3AF]" style={{ fontSize: '12px' }}>
            ...
            {method === 'skinsback' &&
              <>Вы попадёте на SkinsBack, где меняете любые предметы из инвентаря CS2 или Dota 2 —
                ...
                после завершения сделки. Из-за защиты сделок Steam зачисление иногда происходит не
                сразу, а в течение 8 дней — это ограничение самого Steam, а не наше; для проверенных
                аккаунтов обмен часто проходит мгновенно.</>}
            {method === 'cryptobot' &&
